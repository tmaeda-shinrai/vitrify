...
**Not built yet:** #0013 onward (botão "Pedir no WhatsApp" com intent, filtros/busca, intents, stats, PWA, Asaas billing, etc.). `lib/asaas/` and `app/api/` are still stubs.

...
**Not built yet:** #0012 onward (vitrine pública `(public)/[slug]` com ISR, botão "Pedir no WhatsApp", filtros/busca, intents, stats, PWA, Asaas billing, etc.). `lib/asaas/` and `app/api/` are still stubs.

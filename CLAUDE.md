...
**Not built yet:** #0014 onward (filtros/busca/Web Share, persistência de intents + painel de Pedidos `/api/intent`, estatísticas, PWA, Asaas billing, etc.). `lib/asaas/` and `app/api/` are still stubs.

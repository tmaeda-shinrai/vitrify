...
**Not built yet:** #0015 onward (persistência de intents + painel de Pedidos `/api/intent`, estatísticas, PWA, Asaas billing, etc.). `lib/asaas/` and `app/api/` are still stubs.

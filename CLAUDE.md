...
**Not built yet:** #0011 onward (resto do CRUD de produtos — edição/exclusão, múltiplas imagens, categorias, marcas, promo —, vitrine pública `(public)/[slug]`, intents, stats, PWA, Asaas billing, etc.). `lib/asaas/` and `app/api/` are still stubs.

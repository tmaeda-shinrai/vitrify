...
Esta pasta quebra a especificação do produto (`docs/SPEC.md`, principalmente §6 *Escopo do MVP* e §8 *Critérios de pronto*) em issues acionáveis, cruzando com `FEATURES.md`, `ARCHITECTURE.md`, `DATABASE.md`, `DESIGN.md`, `ROADMAP.md`, `PRICING.md` e `LEGAL.md`.
